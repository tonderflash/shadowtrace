...
pub fn draw_file_monitor(frame: &mut Frame, app: &mut App) {
    let size = frame.area();
    ...
    let title = Paragraph::new(Line::from(vec![
        Span::styled("Monitoreo de Archivos", 
    ...
    let block = Block::default()
        .borders(Borders::ALL)
        .title(" Monitoreo de Archivos en Construcción ")
    ...
    let mut animator = BrailleAnimator::new(braille_width, braille_height, AnimationType::Matrix);
